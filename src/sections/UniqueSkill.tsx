...
import { Zap, Clock, Timer, Award } from "lucide-react";
...
export default function UniqueSkill() {
  return (
    <section id="skill" className="mx-auto max-w-6xl px-4 py-12">
      ...
      >
        ...
        <div className="absolute top-4 right-4">
          <Badge
            variant="secondary"
            className="border border-purple-500/30 bg-purple-500/20 text-purple-300"
          >
            {skillData.rarity}
          </Badge>
        </div>
        ...
        <div className="flex flex-col gap-6 md:flex-row">
          ...
          <div className="flex-1 space-y-4">
            {/* Names */}
            <div>
              <h3 className={`text-xl font-bold text-[var(--text-primary)]`} style={{ fontFamily: '"Noto Sans JP", sans-serif' }}>
                {skillData.nameJP}
              </h3>
              <div className="mt-1 flex items-center gap-2">
                <span className="text-base font-semibold text-[var(--accent-pink)]">
                  {skillData.nameCN}
                </span>
