...
const uniqueSkill = {
  nameJP: "愛と熔けよただ熔けよ",
  nameCN: "消融在爱中吧",
  nameEN: "Ai to Tokiyo Tada Tokiyo",
  rarity: "独特",
  restriction: "通用",
  iconColor: "黄色",
  descJP: "残り1000ｍ地点で前の方にいると\n速度が上がる",
  ...
  score: "340",
  ptRatio: "",
  icon: "/images/mejiro-peak-skill-unique.png",
};
...
const inheritSkill = {
  ...
  score: "180",
  ptRatio: "0.90",
  icon: "/images/mejiro-peak-skill-inherit.png",
};
...
export default function MejiroPeak() {
          ...
          <div className="flex flex-col items-center gap-8 lg:flex-row lg:items-start">
            <motion.div variants={containerVariants} initial="hidden" animate="visible" className="flex-1 space-y-6">
              <motion.div variants={itemVariants} className="flex items-center gap-1">
                ...
                <span className="ml-2 text-sm text-[var(--text-muted)]">初始三星 · 目白家的长女</span>
              </motion.div>
              <motion.div variants={itemVariants} className="space-y-2">
                <p className="text-lg font-semibold" style={{ color: "#14b8a6", fontFamily: '"Noto Sans JP", sans-serif' }}>メジロラモーヌ</p>
                <h1 className="text-4xl font-extrabold tracking-tight text-[var(--text-primary)] md:text-5xl">目白高峰</h1>
                <p className="font-[Poppins] text-lg italic text-[var(--text-muted)]">Mejiro Ramonu</p>
              </motion.div>
              ...
              <motion.div variants={itemVariants} className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-elevated)] p-4">
                <p className="text-sm leading-relaxed text-[var(--text-secondary)]">
                  目白家的长女，举止优雅、气质高贵。她那份包容一切的温柔与深沉的爱意，
                  让她在赛马娘中如同姐姐般的存在。黑白色调的长发搭配翠绿色的装饰，
                  决胜服的黑色裙摆与青色上衣尽显成熟魅力。
                </p>
              </motion.div>
            </motion.div>
